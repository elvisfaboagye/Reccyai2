    ...
    <div className={`transition-opacity duration-500 ${isPageLoaded ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center reveal-animation">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Powering <span className="text-reccy-blue">Personalization</span> Worldwide
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="reveal-animation stagger-1">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Founded in 2015, Reccy started with a simple idea: make personalized recommendations accessible to businesses of all sizes.
              </p>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
        ...
        <div className="container mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16 reveal-animation">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Our <span className="text-reccy-blue">Mission</span> & Values
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg reveal-animation stagger-1">
              <h3 className="text-xl font-bold mb-4 text-reccy-blue">Innovation</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg reveal-animation stagger-2">
              <h3 className="text-xl font-bold mb-4 text-reccy-blue">Customer Success</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg reveal-animation stagger-3">
              <h3 className="text-xl font-bold mb-4 text-reccy-blue">Transparency</h3>
              <p className="text-gray-600 dark:text-gray-300">
      ...
      <section className="py-20 px-6 bg-reccy-light dark:bg-gray-900">
        <div className="container mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16 reveal-animation">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Meet Our <span className="text-reccy-blue">Team</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-300">
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="text-reccy-blue text-sm mb-3">{member.role}</div>
            ...
            <div className="reveal-animation">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="bg-reccy-blue/10 p-3 rounded-lg mr-4">
                    <MapPin className="w-5 h-5 text-reccy-blue" />
                  </div>
                  <div>
                ...
                <div className="flex items-start">
                  <div className="bg-reccy-blue/10 p-3 rounded-lg mr-4">
                    <Mail className="w-5 h-5 text-reccy-blue" />
                  </div>
                  <div>
                ...
                <div className="flex items-start">
                  <div className="bg-reccy-blue/10 p-3 rounded-lg mr-4">
                    <Phone className="w-5 h-5 text-reccy-blue" />
                  </div>
                  <div>
              ...
              <form className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input 
                      type="text" 
                      className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-reccy-blue"
                    />
                  </div>
                  <div>
