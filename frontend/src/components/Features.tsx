...
const features = [
  {
    icon: <Target className="w-6 h-6 text-reccy-blue" />,
  ...
  {
    icon: <BarChart className="w-6 h-6 text-reccy-blue" />,
  ...
  {
    icon: <Zap className="w-6 h-6 text-reccy-blue" />,
  ...
  {
    icon: <Layers className="w-6 h-6 text-reccy-blue" />,
...
const Features = () => {
  ...
  return (
    <section
      id="solutions"
      ref={ref}
      className="py-24 px-6 bg-reccy-light dark:bg-gray-900"
    >
      <div className="container mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16 reveal-animation">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Everything You Need for <span className="text-reccy-blue">Intelligent Recommendations</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-reccy-blue/10 p-3 rounded-lg inline-block mb-4">
                {feature.icon}
              </div>
